onload = async function () {
    ...
    const statusMap: any = { pendente: 'Pendente', aprovado: 'Aprovado', cancelado: 'Cancelado', rejeitado: 'Rejeitado' };
    const statusClassMap: any = { pendente: 'badge-pendente', aprovado: 'badge-aprovado', cancelado: 'badge-cancelado', rejeitado: 'badge-rejeitado' };
